          ...
          <ul class="navbar-nav ml-auto">
           ...
           <li class="nav-item cta cta-colored"><a href="cart.php" class="nav-link" style="color: white"><span class="icon-shopping_cart"></span>[0]</a></li>
              <li class="nav-item dropdown">
                <li class="nav-item active"><a href="wishlist.php" class="nav-link"style="color: white">Lista de deseos</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html" style="color: white">Inicio</a></span></p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-start">
          <div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
            ...
            <p class="text-center"><a href="checkout.html" class="btn btn-primary py-3 px-4">Enviar a carrito de compras</a></p>
          </div>
        </div>
      </div>
    </section>
