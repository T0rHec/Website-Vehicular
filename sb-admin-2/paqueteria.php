    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="adminPaqueteria.php" method="POST" class="needs-validation" novalidate>
            <div class="form-row">
              ...
              <div class="my-2"></div>
              <div class="col-md-3 mb-3">
                <input name="paqueteriaId" type="text" class="form-control" id="formGroupExampleInput" placeholder="ID Paqueteria">
              </div>
          </form>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <iframe src="tablaPaqueteria.php" width="100%" height="500px" frameborder="0"></iframe>
              </div>
            </div>
          </div>
