    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="adminRopa.php" method="POST" class="needs-validation" novalidate>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationCustomid">ID Prenda</label>
                <div class="input-group">
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <input name="color" type="text" class="form-control" id="validationCustom03" placeholder="" required>
                <div class="invalid-feedback">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <iframe src="tablaRopa.php" width="100%" height="500px" frameborder="0"></iframe>
              </div>
            </div>
          </div>
