    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="adminEmpleado.php" method="POST" class="needs-validation" novalidate>
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="last_name" type="text" class="form-control" id="validationCustom02" placeholder="" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
            ...
            <div class="form-row">
              <div class="col-md-3 mb-3">
                ...
                <input name="tel" type="text" class="form-control" id="validationCustom04" placeholder="" required>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input name="email" type="email" class="form-control" id="validationCustom04" placeholder="" required>
                <div class="invalid-feedback">
                  Please provide a valid ID.
                </div>
              </div>
              <div class="col-md-3 mb-3">
                ...
                <input name="password" type="password" class="form-control" id="validationCustom04" placeholder="" required>
                <div class="invalid-feedback">
                  Please provide a valid ID.
                </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="validationCustom04">Salario</label>
                <input name="salario" type="text" class="form-control" id="validationCustom04" placeholder="" required>
                <div class="invalid-feedback">
                  Please provide a valid ID.
                </div>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <input name="rfc" type="text" class="form-control" id="validationCustom03" placeholder="" required>
                <div class="invalid-feedback">
              ...
              <div class="my-2"></div>
              <div class="col-md-3 mb-3">
                <input name="empleadoId" type="text" class="form-control" id="formGroupExampleInput" placeholder="ID Empleado">
              </div>
          </form>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <iframe src="tablaEmpleado.php" width="100%" height="500px" frameborder="0"></iframe>
              </div>
            </div>
          </div>
