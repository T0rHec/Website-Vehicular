    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="adminCompra.php" method="POST" class="needs-validation" novalidate>
            <div class="form-row">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input name="cantidad" type="text" class="form-control" id="validationCustom04" placeholder="" required>
                <div class="invalid-feedback">
                  Please provide a valid ID.
                </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="validationCustom04">ID Proveedor</label>
                <input name="proveedorId" type="text" class="form-control" id="validationCustom04" placeholder="" required>
                <div class="invalid-feedback">
                  Please provide a valid ID.
                </div>
              </div>
              ...
              <div class="my-2"></div>
              <div class="col-md-3 mb-3">
                <input name="compraId" type="text" class="form-control" id="formGroupExampleInput" placeholder="ID Compra">
              </div>
          </form>
