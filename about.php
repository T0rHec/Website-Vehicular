...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="about.php" class="nav-link" style="color: white">Nosotros</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread" style="color: white">Acerca de nosotros</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/about.jfif);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Los mejores desde 2018</h2>
	            </div>
	          </div>
	          <div class="pb-md-5 pb-4">
							<p>A pesar de ser relativamente nuevos en el mercado, somos personas profesionales que brindamos la mayor importancia a la experiencia del cliente y la calidad de nuestros vehículos</p>
							<p>Si existe alguna duda haremos todo lo posible por brindarle la mejor atención posible.</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Esta plantilla fue hecha con <i class="icon-heart color-danger" aria-hidden="true"></i> por <a href="https://colorlib.com" target="_blank">Equipo vehicular</a>
